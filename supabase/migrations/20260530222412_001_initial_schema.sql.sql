/*
  ...
  Creates the core tables for the Clinicus medical education platform.
...
-- Conteudos table (resumos, simulados, casos clinicos)
CREATE TABLE IF NOT EXISTS public.conteudos (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  tipo TEXT NOT NULL CHECK (tipo IN ('resumo', 'simulado', 'caso_clinico')),
  titulo TEXT NOT NULL,
  disciplina TEXT NOT NULL,
  ciclo TEXT NOT NULL CHECK (ciclo IN ('basico', 'clinico')),
