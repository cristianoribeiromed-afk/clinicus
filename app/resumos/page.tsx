...
export default function ResumosPage() {
  ...
  const disciplinasDisponiveis = Array.from(new Set(contents.map((c) => c.disciplina)));
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Conteudo organizado por disciplina com linguagem simplificada</p>
            </div>
          </div>
        </motion.div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 rounded-xl bg-secondary/10 border border-secondary/20">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Desbloqueie todos os resumos</p>
                <p className="text-xs text-muted-foreground">Plano Free inclui 2 resumos por disciplina</p>
              </div>
              <Link href="/planos">
                <Button size="sm" variant="secondary">Ver Planos</Button>
              </Link>
            </div>
          </motion.div>
        )}
