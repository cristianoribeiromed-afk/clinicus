...
// Realistic medical content data
const RESUMO_FISIOLOGIA_CARDIACA_1 = {
  id: 'resumo-1',
  tipo: 'resumo' as const,
  titulo: 'Potencial de Acao Cardiaco - Propriedades Eletricas',
  disciplina: 'fisiologia',
  ciclo: 'basico' as const,
  descricao: 'Revisao completa sobre o potencial de acao cardiaco, incluindo fases, canais ionicos envolvidos e diferencas entre celulas de marcapasso e cardiomiocitos.',
  premium: false,
...
const RESUMO_FISIOLOGIA_CARDIACA_2 = {
  ...
  disciplina: 'fisiologia',
  ciclo: 'basico' as const,
  descricao: 'Sequencia completa dos eventos mecanicos do ciclo cardiaco: sistole atrial, sistole ventricular, diastole isovolumetrica e enchimento ventricular.',
  premium: true,
  ...
  conteudo_html: `
    ...
    <ul>
      <li>Fase de contracao isovolumetrica: Todas valvulas fechadas, pressao sobe sem variacao de volume</li>
      <li>Ejecao: Valvulas semilunares abrem, sangue e eietado para aorta e artia pulmonar</li>
    </ul>
    <h3>3. Diastole Ventricular (0,4s)</h3>
    <ul>
      <li>Relaxamento isovolumetrico: Todas valvulas fechadas, pressao cai</li>
      <li>Enchimento rapido: Valvulas AV abrem,enchimento passivo veloz</li>
    ...
    <p><strong>B3:</strong> Enchimento ventricular rapido (patologicoAdulto)</p>
    <p><strong>B4:</strong> Contracao atrial forca (estenose mitral, hipertrofia ventricular)</p>
  `,
  visualizacoes: 980,
};

const QUESTOES_MICROBIOLOGIA: Questao[] = [
  {
    id: 'q1',
    enunciado: 'Um paciente de 25 anos apresenta uretrite purulenta apos contato sexual desprotegido. A cultura em agar Thayer-Martin revela diplococos gram-negativos oxidase-positivos. Qual e o agente etiologico mais provavel?',
    alternativas: [
    ...
    gabarito: 1,
    explicacao: 'Neisseria gonorrhoeae e um diplococo gram-negativo que cresce em agar Thayer-Martin (contem vancomicina, colistina, nistatina e trimetoprima). A oxidase positiva e caracteristica do genero Neisseria. A uretrite purulenta e manifestacao classica da gonorreia.',
    dificuldade: 'medio',
  },
  {
    id: 'q2',
    enunciado: 'Uma gestante de 32 semanas apresenta ruptura prematura das membranas. A microbiologia identifica bacilo gram-negativo, beta-hemolitico, com teste de CAMP positivo. Qual o agente e a profilaxia indicada?',
    alternativas: [
    ...
    gabarito: 1,
    explicacao: 'O teste de CAMP e caracteristico do Streptococcus agalactiae (GBS), que e beta-hemolitico. A colonizacao materna por GBS indica necessidade de profilaxia intraparto com Penicilina G (ou ampicilina) para prevenir infeccao neonatal grave.',
    dificuldade: 'dificil',
  },
  {
    id: 'q3',
    enunciado: 'Paciente com historia de viagem a area rural apresenta febre alta, cefaleia intensa e exantema petequial. O diagnostico de Rickettsia rickettsii e suspeitado. Qual e o vetor transmissor deste agente?',
    alternativas: [
    ...
    gabarito: 1,
    explicacao: 'Rickettsia rickettsii, agente da Febre das Montanhas Rochosas, e transmitida por carrapatos do genero Dermacentor. A doenca caracteriza-se por febre, cefaleia e exantema que comeca em pulsos e maos antes de disseminar.',
    dificuldade: 'medio',
  },
  {
    id: 'q4',
    enunciado: 'Um paciente de 45 anos, alcoolatra cronico, apresenta pneumonia приобретida na comunidade. A cultura de escarro mostra diplococos gram-positivos sensiveis a optoquina. Qual o agente e o fator de virulencia principal?',
    alternativas: [
    ...
    gabarito: 1,
    explicacao: 'Streptococcus pneumoniae e um diplococo gram-positivo, sensivel a optoquina (diferencia de outros estreptococos viridans). A capsula polissacaridica e seu principal fator de virulencia, evitando a fagocitose. Alcoolismo cronico e fator de risco importante.',
    dificuldade: 'facil',
  },
  {
    id: 'q5',
    enunciado: 'Um laboratorio identifica uma bacteria com as seguintes caracteristicas: bacilo gram-negativo, nao fermentador de lactose, oxidase positiva, mobilidade em agar SIM, crescimento a 42C. Qual e o agente mais provavel?',
    alternativas: [
      'Escherichia coli',
    ...
    gabarito: 1,
    explicacao: 'Pseudomonas aeruginosa possui estas caracteristicas: Nao fermentador (nao fermenta lactose), oxidase positiva, mobilidade presente, crescimento a 42C (importante para diferenciar de outras Pseudomonas). E. coli fermenta lactose e e oxidase negativa.',
    dificuldade: 'medio',
  },
];
...
const SIMULADO_MICROBIOLOGIA_1 = {
  ...
  ciclo: 'basico' as const,
  descricao: 'Simulado com questoes sobre bacterias gram-negativas de importancia medica: Enterobacterias, Nisserias, Pseudomonas e outras.',
  premium: false,
  tags: ['microbiologia', 'bacterias', 'gram-negativas', 'diagnostico'],
  questoes: QUESTOES_MICROBIOLOGIA.slice(0, 3),
...
const SIMULADO_MICROBIOLOGIA_2 = {
  ...
  disciplina: 'microbiologia',
  ciclo: 'basico' as const,
  descricao: 'Simulado completo com 5 questoes sobre diagnostico laboratorial de infeccoes bacterianas, incluindo testes bioquimicos e metodologias de identificacao.',
  premium: true,
  tags: ['microbiologia', 'diagnostico', 'laboratorio', 'testes bioquimicos'],
  questoes: QUESTOES_MICROBIOLOGIA,
  tempo_por_questao: 90,
  visualizacoes: 1560,
};

const CASO_CLINICO_CARDIOLOGIA_1 = {
  id: 'caso-cardio-1',
  tipo: 'caso_clinico' as const,
  titulo: 'Homem de 55 anos com dor toracica opressiva',
  disciplina: 'cardiologia',
  ciclo: 'clinico' as const,
  descricao: 'Caso clinico sobre abordagem inicial de sindrome coronariana aguda com supradesnivelamento do segmento ST.',
  premium: false,
...
iniciada ha 2 horas em repouso. Negica dispneia. PA: 160/100 mmHg; FC: 98 bpm; SatO2: 96% ar ambiente.
  `,
  exames: [
    { nome: 'ECG', resultado: 'Supradesnivelamento ST em V1-V4 (derivacoes anteriores)', interpretacao: 'Padrao compativel com IAMCSST de parede anterior' },
    { nome: 'Troponina I', resultado: 'Elevada (12,5 ng/mL - VR < 0,04)', interpretacao: 'Confirmacao de lesao miocardica' },
    { nome: 'Creatinina', resultado: '1,2 mg/dL', interpretacao: 'Funcao renal preservada' },
  ],
  questoes: [
    {
      id: 'cq1',
      enunciado: 'Qual e o tratamento imediato indicado para este paciente (fase hospitalar)?',
      alternativas: [
      ...
      gabarito: 0,
      explicacao: 'A ICP primaria (angioplastia) e o tratamento de escolha para IAMCSST quando disponivel em ate 120min do contato medico. O esquema de antiagregacao (AAS + P2Y12) associado a anticoagulacao deve ser iniciado imediatamente. Trombolite e indicada quando ICP nao esta disponivel em tempo adequado.',
      dificuldade: 'dificil',
    },
  ],
  visualizacoes: 1200,
...
const CASO_CLINICO_CARDIOLOGIA_2 = {
  id: 'caso-cardio-2',
  tipo: 'caso_clinico' as const,
  titulo: 'Mulher de 28 anos com dispneia progressiva e edema de MMII',
  disciplina: 'cardiologia',
  ciclo: 'clinico' as const,
  descricao: 'Caso clinico abordando diagnostico diferencial de doen valvar reumatica em paciente jovem.',
  premium: true,
...
rumoroso em foco mitral, estalido de abertura. Edema de MMII bilateral.
  `,
  exames: [
    { nome: 'Ecocardiograma', resultado: 'Valva mitral com movimentacao em "hockey stick", area valvar de 0,9 cm2, gradiente medio de 18 mmHg. AE aumentado (52 mm)', interpretacao: 'Estenose mitral severa de origem reumatica' },
    { nome: 'ECG', resultado: 'Ritmo atrial fibrilatorio, CV: 110 bpm, sobrecarga atrial esquerda', interpretacao: 'FA conducao comum em estenose mitral cronica' },
  ],
  questoes: [
    {
      id: 'cq2',
      enunciado: 'Qual e a conduta terapeutica mais apropriada para esta paciente?',
      alternativas: [
        'Tratamento clinico com diureticos e betabloqueador, retorno ambulatorial',
...
async function seedDatabase() {
  ...
  // Insert resumos
  const resumosInsert = [
    { ...RESUMO_FISIOLOGIA_CARDIACA_1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { ...RESUMO_FISIOLOGIA_CARDIACA_2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ];

  const { error: resumoError } = await supabase.from('conteudos').upsert(resumosInsert, { onConflict: 'id' });
  ...
  const simuladosInsert = [
    { ...SIMULADO_MICROBIOLOGIA_1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { ...SIMULADO_MICROBIOLOGIA_2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ];

  const { error: simuladoError } = await supabase.from('conteudos').upsert(simuladosInsert, { onConflict: 'id' });
  if (simuladoError) console.error('Error inserting simulados:', simuladoError);
  else console.log('Simulados inserted successfully');

  // Insert casos clinicos
  const casosInsert = [
    { ...CASO_CLINICO_CARDIOLOGIA_1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { ...CASO_CLINICO_CARDIOLOGIA_2, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ];

  const { error: casoError } = await supabase.from('conteudos').upsert(casosInsert, { onConflict: 'id' });
  if (casoError) console.error('Error inserting casos clinicos:', casoError);
  else console.log('Casos clinicos inserted successfully');
