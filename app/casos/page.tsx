      ...
      <div className="p-4 lg:p-8 space-y-6">
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold">Casos Clinicos</h1>
              <p className="text-muted-foreground">Aprimore seu raciocinio clinico com casos comentados</p>
            </div>
          </div>
        </motion.div>

        {!isPremium && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="p-4 rounded-xl bg-primary/10 border border-primary/20">
            <div className="flex items-center gap-3">
              <Crown className="w-5 h-5 text-primary" />
              <div className="flex-1">
                <p className="text-sm font-medium">Todos os casos clinicos sao exclusivos Premium</p>
                <p className="text-xs text-muted-foreground">Assine para acessar conteudo completo</p>
              </div>
              <Link href="/planos">
